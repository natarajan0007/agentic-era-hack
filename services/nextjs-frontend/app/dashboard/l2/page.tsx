...
export default function L2DashboardPage() {
  const assignedTickets = mockTickets.filter(
    (ticket) =>
      ticket.assignedTo === "l2@intellica.com" && ["open", "in-progress", "escalated"].includes(ticket.status),
  )

  const metrics = mockMetrics.l2
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics.escalatedTicketsResolved}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics.rcaCompletionRate}%</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{metrics.complexIssuesResolved}</div>
